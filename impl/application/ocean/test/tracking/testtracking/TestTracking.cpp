...
#include "application/ocean/test/tracking/testtracking/TestTracking.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"similaritytracker\"");
