...
#include "application/ocean/test/geometry/testgeometry/TestGeometry.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"jacobian, p3p\"");
