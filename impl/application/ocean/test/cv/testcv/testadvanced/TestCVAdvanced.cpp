...
#include "application/ocean/test/cv/testcv/testadvanced/TestCVAdvanced.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"advancedframeshrinker\"");
	...
	{
		std::cout << "Ocean Framework test for the CV Advanced library:" << std::endl << std::endl;
	...
	Log::info() << "Ocean Framework test for the Advanced Computer Vision library:";
	Log::info() << " ";
	...
	try
	{
		if (Test::TestCV::TestAdvanced::testCVAdvanced(testDuration, worker, testWidth, testHeight, functionList))
		{
			resultValue = 0;
		}
	}
