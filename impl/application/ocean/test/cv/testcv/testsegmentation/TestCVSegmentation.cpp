...
#include "application/ocean/test/cv/testcv/testsegmentation/TestCVSegmentation.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"binpacking\"");
	...
	try
	{
		if (Test::TestCV::TestSegmentation::testCVSegmentation(testDuration, worker, testWidth, testHeight, functionList))
		{
			resultValue = 0;
		}
	}
