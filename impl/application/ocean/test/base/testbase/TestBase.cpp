...
#include "application/ocean/test/base/testbase/TestBase.h"
...
#endif
{
	...
	{
		std::cout << "Ocean Framework test for the Base library:" << std::endl << std::endl;
	...
	Log::info() << "Ocean Framework test for the Base library";
	...
	try
	{
		if (Test::TestBase::testBase(testDuration, worker, functionList))
		{
			resultValue = 0;
		}
	}
