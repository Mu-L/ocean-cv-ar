...
#include "application/ocean/test/platform/testplatform/TestPlatform.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"apple\"");
