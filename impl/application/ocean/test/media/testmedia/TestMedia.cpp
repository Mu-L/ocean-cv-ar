...
#include "application/ocean/test/media/testmedia/TestMedia.h"
...
#endif
{
	...
	commandArguments.registerParameter("functions", "f", "The optional subset of functions to test, e.g., \"openimagelibraries\"");
