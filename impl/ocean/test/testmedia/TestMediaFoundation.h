...
#ifndef META_OCEAN_TEST_TESTMEDIA_TEST_MEDIA_FOUNDATION_H
#define META_OCEAN_TEST_TESTMEDIA_TEST_MEDIA_FOUNDATION_H
...
/**
 * This class implements tests for MediaFoundation media functionality.
 * @ingroup testmedia
 */
class OCEAN_TEST_MEDIA_EXPORT TestMediaFoundation
{
	public:
...
#endif // META_OCEAN_TEST_TESTMEDIA_TEST_MEDIA_FOUNDATION_H
